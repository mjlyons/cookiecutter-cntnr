...
export {{cookiecutter.envvar_prefix|upper}}_PROD_HOSTNAME="{{cookiecutter.prod_fqdn}}"
...
export {{cookiecutter.envvar_prefix|upper}}_PROD_IP="$(dig +tcp +short ${{cookiecutter.envvar_prefix|upper}}_PROD_HOSTNAME)"
